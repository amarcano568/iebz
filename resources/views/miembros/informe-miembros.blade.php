...
<div class="title_left">
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6" style="float: right;">
            <select class="chosen-select" id="ordenado" name="ordenado" data-placeholder="Seleccione el Orden...">
                <option value="1">Ordenado por Nombres</option>
                <option value="2">Ordenado por Apellidos</option>
            </select>
        </div>
