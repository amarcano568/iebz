...
<html lang="es">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="img/hisraelstarofdavid_89245.ico" />
        <title>SISTEMA DE GESTION DE MIEMBROS IGLESIA EVANGÉLICA BAUTISTA DE ZARAGOZA</title>
    ...
    <body class="nav-md">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            ...
                            <a href="{{URL::to('/')}}" class="site_title"><img src="{{ asset('img/LOGO_web_blanco.png') }}" height="50" width="50"> <span>GESTION v2.0</span></a>
                        </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li>
                                        <a href="{{URL::to('/')}}">
                                            <i style="font-size: 20px;" class="fas fa-home"></i> Inicio </a>
                                    </li>
                                    @endcan

                                    @can('miembros')
                                    <li>
                                        <a href="{{URL::to('miembros')}}">  
                                ...
                                @can('menu.administracion')
                                    <li>
                                        <a><i style="font-size: 20px;" class="fas fa-cogs"></i>  Administración&emsp;&emsp;&emsp;<span class="fas fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
        ...
        <footer>
            <div class="pull-right">
                <a href="">Desarrollado por Ing. Alexander Marcano A. </a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
